...
class Config:
    def __init__(self, data='dataset1',seq_len=720, pred_len=24, dec_seq_len=24, hidden_size=128, heads=3, batch_size=100, embedding_size=32,
    ...
    def extend_argv(self):
        ...
        if self.prediction_type == 'uni':
            ...
            sys.argv.extend(["--input_len", '2', "--output_len", "2"])
...
def build_parser():
    ...
    parser.add_argument('--target', default='Charge_Capacity(Ah)', type=str)
