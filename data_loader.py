...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None, 
                 features='S', data_path='dataset1.csv', 
                 target='Voltage(V)', scale=True, inverse=False, timeenc=0, freq='h'):
    ...
    def __read_data__(self):
        ...
        cols = list(df_raw.columns); cols.remove(self.target); cols.remove('Date_Time')
